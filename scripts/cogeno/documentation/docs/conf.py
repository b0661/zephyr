...
breathe_dir = str(Path(__file__).parent.joinpath("../_build/doxy/xml").resolve())
breathe_projects = { "cogeno": breathe_dir}
...
def generate_doxygen_xml(app):
    """Run the doxygen commands if we're on the ReadTheDocs server"""

    read_the_docs_build = os.environ.get('READTHEDOCS', None) == 'True'

    doxyfile_dir = str(Path(__file__).parent.joinpath("..").resolve())
