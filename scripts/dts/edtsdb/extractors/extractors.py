...
from .gpioranges import DTGpioRanges
from .gpios import DTGpios
...
class Extractors(ExtractorsBase):
    ...
    def __init__(self, edts, dts, bindings):
        ...
        self.gpioranges = DTGpioRanges(self)
        self.gpios = DTGpios(self)
    ...
    def extract_gpioranges(self, node_address, prop):
        self.gpioranges.extract(node_address, prop)

    def extract_gpios(self, node_address, prop):
        self.gpios.extract(node_address, prop)
