...
/**
 * @file
 * Code generation template for basic device tree data access.
 */

/**
 * @brief DTS basic template.
 * @defgroup codegen_templates_dts_basic DTS basic template.
 * @ingroup codegen_templates
 *
 * Code generation template for basic device tree data access.
 *
 * The template does not generate code but provides utility function to access
 * device tree data.
 *
 * Usage example:
...
/** Utility functions for basic device tree data access.
 * @code{.codegen}
 *
