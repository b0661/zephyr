...
These functions must be enabled by :c:macro:`CONFIG_PINCTRL_MUX_REQUEST`.
...
:c:macro:`CONFIG_PINCTRL_MUX_REQUEST`
    Enable access management to pin multiplexers.

:c:macro:`CONFIG_PINCTRL_PINMUX`
    The generic shim that maps from the pinmux interface to the pinctrl interface
    is enabled.
...
The general device information for pin controllers is:
...
For a pin controller node five data sets are extracted from the device tree and
provided in :file:`generated_dts_board.h`.
...
C preprocessor to generate driver structures and content.

Using the pin controller library
--------------------------------

The pin controller library :file:`pinctrl_lib.h` is a template for pin
controller driver implementation. The template parameters are given by simple
defines. The template is expanded by the C preprocessor with the help of
the :ref:`chaos_pp`. The template generates the appropriate data structures
and fills them using the information provided in :file:`generated_dts_board.h`.
...
Additionally two macro functions have to be provided that extract the pin number
and the multiplexer value from the pinmux value(s) given in the device tree:

    - :c:macro:`CONFIG_PINCTRL_LIB_PINCONF_PINMUX_PIN`
    - :c:macro:`CONFIG_PINCTRL_LIB_PINCONF_PINMUX_MUX`

The template parameters are:

:c:macro:`CONFIG_PINCTRL_LIB_SELECT_PINMUX`
    Select pin configuration by pinmux property [0,1].
:c:macro:`CONFIG_PINCTRL_LIB_SELECT_GROUP`
    Select pin configuration by group property [0,1].
:c:macro:`CONFIG_PINCTRL_LIB_SELECT_PINS`
    Select pin configuration by pins property [0,1].
:c:macro:`CONFIG_PINCTRL_LIB_DEVICE_NAME_PREFIX`
    C function prefix for pinctrl devices (e.g. pinctrl_stm32)
:c:macro:`CONFIG_PINCTRL_LIB_CONFIG_GET`
    C function name of device config_get function.
:c:macro:`CONFIG_PINCTRL_LIB_CONFIG_SET`
    C function name of device mux_free function.
:c:macro:`CONFIG_PINCTRL_LIB_MUX_GET`
    C function name of device mux_get function.
:c:macro:`CONFIG_PINCTRL_LIB_MUX_SET`
    C function name of device mux_set function.
:c:macro:`CONFIG_PINCTRL_LIB_PINCONF_PINMUX_PIN`
    Name of C macro that extracts pin number from pinmux property.
:c:macro:`CONFIG_PINCTRL_LIB_PINCONF_PINMUX_MUX`
    Name of C macro that extracts mux value from pinmux property.
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_COUNT`
    Number of pin controllers to be generated.
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_0_PREFIX`
    Prefix of device tree defines of controller 0.
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_0_DATA`
    Address of data of controller 0 (e.g. pinctrl_stm32_data[0]).
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_0_PIN_COUNT`
    Number of pins controlled by controller 0.
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_0_DEVICE_INIT`
    C function name of device init function for controller 0.
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_1_PREFIX`
    Prefix of device tree defines of controller 1.
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_1_DATA`
    Address of data of controller 1 (e.g. pinctrl_stm32_data[1]).
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_1_PIN_COUNT`
    Number of pins controlled by controller 1.
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_1_DEVICE_INIT`
    C function name of device init function for controller 1.
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_2_PREFIX`
    Prefix of device tree defines of controller 2.
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_2_DATA`
    Address of data of controller 2 (e.g. pinctrl_stm32_data[2]).
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_2_PIN_COUNT`
    Number of pins controlled by controller 2.
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_2_DEVICE_INIT`
    C function name of device init function for controller 2.
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_3_PREFIX`
    Prefix of device tree defines of controller 3.
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_3_DATA`
    Address of data of controller 3 (e.g. pinctrl_stm32_data[3]).
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_3_PIN_COUNT`
    Number of pins controlled by controller 3.
:c:macro:`CONFIG_PINCTRL_LIB_CONTROLLER_3_DEVICE_INIT`
    C function name of device init function for controller 3.

The structure of a pin controller driver may look like this example
of the STM32 driver (files: :file:`drivers/pinctrl/pinctrl_stm32.h`,
:file:`drivers/pinctrl/pinctrl_stm32.c`):

.. code-block:: C
    :caption: Example pinctrl_stm32.h
    ...
    ...
    /* ------------------------------------------ */
    /* Driver configuration data from SoC         */
    /* ------------------------------------------ */
    ...
    #include <soc.h>
