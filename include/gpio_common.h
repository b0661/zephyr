...
/**
 * @brief GPIO Port Pin Defines
 * @defgroup gpio_interface_port_pin_defs GPIO Port Pin Defines
 * @ingroup gpio_interface
 * @{
 */

#define GPIO_PORT_PIN(idx)	(idx)
...
/**
 * @brief GPIO Port Mask Pin Defines
 * @defgroup gpio_interface_port_mask_pin_defs GPIO Port Mask Pin Defines
 * @ingroup gpio_interface
 * @{
 */

/**
 * @def GPIO_PORT_MASK_PIN
 * @brief Helper to create port mask from pin index.
 *
 * @param idx Index of pin within port [0..31]
 * @return Port mask for pin
 */
#define GPIO_PORT_MASK_PIN(idx)  (1U << (idx))

/**
 * @def GPIO_PORT_MASK_PIN_IDX
 * @brief Helper to create port pin index from port mask of pin.
 *
 * Port mask of pin shall be one of GPIO_PORT_MASK_PINx (only one bit set).
 *
 * @note For runtime calculation use gpio_port_mask_pin_idx() instead.
 *
 * @param port_mask_pin port mask of pin
 * @return Index of pin within port [0..31]
 */
#define GPIO_PORT_MASK_PIN_IDX(port_mask_pin) ( \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(0))  >>  0) *  0) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(1))  >>  1) *  1) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(2))  >>  2) *  2) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(3))  >>  3) *  3) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(4))  >>  4) *  4) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(5))  >>  5) *  5) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(6))  >>  6) *  6) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(7))  >>  7) *  7) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(8))  >>  8) *  8) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(9))  >>  9) *  9) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(10)) >> 10) * 10) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(11)) >> 11) * 11) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(12)) >> 12) * 12) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(13)) >> 13) * 13) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(14)) >> 14) * 14) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(15)) >> 15) * 15) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(16)) >> 16) * 16) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(17)) >> 17) * 17) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(18)) >> 18) * 18) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(19)) >> 19) * 19) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(20)) >> 20) * 20) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(21)) >> 21) * 21) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(22)) >> 22) * 22) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(23)) >> 23) * 23) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(24)) >> 24) * 24) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(25)) >> 25) * 25) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(26)) >> 26) * 26) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(27)) >> 27) * 27) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(28)) >> 28) * 28) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(29)) >> 29) * 29) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(30)) >> 30) * 30) + \
	(((port_mask_pin & GPIO_PORT_MASK_PIN(31)) >> 31) * 31))

/**
 * @def GPIO_PORT_MASK_PIN0
 * @brief Pin 0 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN0		GPIO_PORT_MASK_PIN(0)

/**
 * @def GPIO_PORT_MASK_PIN1
 * @brief Pin 1 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN1		GPIO_PORT_MASK_PIN(1)

/**
 * @def GPIO_PORT_MASK_PIN2
 * @brief Pin 2 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN2		GPIO_PORT_MASK_PIN(2)

/**
 * @def GPIO_PORT_MASK_PIN3
 * @brief Pin 3 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN3		GPIO_PORT_MASK_PIN(3)

/**
 * @def GPIO_PORT_MASK_PIN4
 * @brief Pin 4 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN4		GPIO_PORT_MASK_PIN(4)

/**
 * @def GPIO_PORT_MASK_PIN5
 * @brief Pin 5 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN5		GPIO_PORT_MASK_PIN(5)

/**
 * @def GPIO_PORT_MASK_PIN6
 * @brief Pin 6 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN6		GPIO_PORT_MASK_PIN(6)

/**
 * @def GPIO_PORT_MASK_PIN7
 * @brief Pin 7 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN7		GPIO_PORT_MASK_PIN(7)

/**
 * @def GPIO_PORT_MASK_PIN8
 * @brief Pin 8 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN8		GPIO_PORT_MASK_PIN(8)

/**
 * @def GPIO_PORT_MASK_PIN9
 * @brief Pin 9 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN9		GPIO_PORT_MASK_PIN(9)

/**
 * @def GPIO_PORT_MASK_PIN10
 * @brief Pin 10 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN10		GPIO_PORT_MASK_PIN(10)

/**
 * @def GPIO_PORT_MASK_PIN11
 * @brief Pin 11 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN11		GPIO_PORT_MASK_PIN(11)

/**
 * @def GPIO_PORT_MASK_PIN12
 * @brief Pin 12 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN12		GPIO_PORT_MASK_PIN(12)

/**
 * @def GPIO_PORT_MASK_PIN13
 * @brief Pin 13 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN13		GPIO_PORT_MASK_PIN(13)

/**
 * @def GPIO_PORT_MASK_PIN14
 * @brief Pin 14 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN14		GPIO_PORT_MASK_PIN(14)

/**
 * @def GPIO_PORT_MASK_PIN15
 * @brief Pin 15 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN15		GPIO_PORT_MASK_PIN(15)

/**
 * @def GPIO_PORT_MASK_PIN16
 * @brief Pin 16 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN16		GPIO_PORT_MASK_PIN(16)

/**
 * @def GPIO_PORT_MASK_PIN17
 * @brief Pin 17 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN17		GPIO_PORT_MASK_PIN(17)

/**
 * @def GPIO_PORT_MASK_PIN18
 * @brief Pin 18 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN18		GPIO_PORT_MASK_PIN(18)

/**
 * @def GPIO_PORT_MASK_PIN19
 * @brief Pin 19 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN19		GPIO_PORT_MASK_PIN(19)

/**
 * @def GPIO_PORT_MASK_PIN20
 * @brief Pin 20 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN20		GPIO_PORT_MASK_PIN(20)

/**
 * @def GPIO_PORT_MASK_PIN21
 * @brief Pin 21 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN21		GPIO_PORT_MASK_PIN(21)

/**
 * @def GPIO_PORT_MASK_PIN22
 * @brief Pin 22 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN22		GPIO_PORT_MASK_PIN(22)

/**
 * @def GPIO_PORT_MASK_PIN23
 * @brief Pin 23 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN23		GPIO_PORT_MASK_PIN(23)

/**
 * @def GPIO_PORT_MASK_PIN24
 * @brief Pin 24 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN24		GPIO_PORT_MASK_PIN(24)

/**
 * @def GPIO_PORT_MASK_PIN25
 * @brief Pin 25 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN25		GPIO_PORT_MASK_PIN(25)

/**
 * @def GPIO_PORT_MASK_PIN26
 * @brief Pin 26 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN26		GPIO_PORT_MASK_PIN(26)

/**
 * @def GPIO_PORT_MASK_PIN27
 * @brief Pin 27 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN27		GPIO_PORT_MASK_PIN(27)

/**
 * @def GPIO_PORT_MASK_PIN28
 * @brief Pin 28 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN28		GPIO_PORT_MASK_PIN(28)

/**
 * @def GPIO_PORT_MASK_PIN29
 * @brief Pin 29 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN29		GPIO_PORT_MASK_PIN(29)

/**
 * @def GPIO_PORT_MASK_PIN30
 * @brief Pin 30 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN30		GPIO_PORT_MASK_PIN(30)

/**
 * @def GPIO_PORT_MASK_PIN31
 * @brief Pin 31 of the GPIO port mask.
 */
#define GPIO_PORT_MASK_PIN31		GPIO_PORT_MASK_PIN(31)
