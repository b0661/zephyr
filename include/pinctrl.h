...
/**
 * @def PINCTRL_CONFIG
 * @brief Create a pinctrl config value from pinctrl configuration defines.
 *
 * The pinctrl configuration defines shall be the
 * @ref pinctrl_interface_config_defs "pinctrl configuration defines"
 * as given in the pinctrl_common.h file.
 */
...
{
	return (func < PINCTRL_FUNCTION_PINMUX_BASE);
}
...
__syscall int pinctrl_config_group_get(struct device *dev,
			u16_t group, u32_t *configs, u16_t *num_configs);
...
__syscall int pinctrl_config_group_set(struct device *dev,
			u16_t group, const u32_t *configs, u16_t num_configs);
...
#define PINMUX_FUNC_A		PINCTRL_FUNCTION_PINMUX_0
#define PINMUX_FUNC_B		PINCTRL_FUNCTION_PINMUX_1
#define PINMUX_FUNC_C		PINCTRL_FUNCTION_PINMUX_2
#define PINMUX_FUNC_D		PINCTRL_FUNCTION_PINMUX_3
#define PINMUX_FUNC_E		PINCTRL_FUNCTION_PINMUX_4
#define PINMUX_FUNC_F		PINCTRL_FUNCTION_PINMUX_5
#define PINMUX_FUNC_G		PINCTRL_FUNCTION_PINMUX_6
#define PINMUX_FUNC_H		PINCTRL_FUNCTION_PINMUX_7
