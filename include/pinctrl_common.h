...
/**
 * @brief PINCTRL Pin Configuration Defines
 * @defgroup pinctrl_interface_config_defs PINCTRL Pin Configuration Defines
...
/**@} pinctrl_interface_config_defs */

/**
 * @brief PINCTRL Pin Multiplexing Defines
 * @defgroup pinctrl_interface_mux_defs PINCTRL Pin Multiplexing Defines
 * @ingroup pinctrl_interface
 * @{
 */

#define PINCTRL_FUNCTION_PINMUX_BASE	0x8000U
#define PINCTRL_FUNCTION_PINMUX_0	(PINCTRL_FUNCTION_PINMUX_BASE + 0)
#define PINCTRL_FUNCTION_PINMUX_1	(PINCTRL_FUNCTION_PINMUX_BASE + 1)
#define PINCTRL_FUNCTION_PINMUX_2	(PINCTRL_FUNCTION_PINMUX_BASE + 2)
#define PINCTRL_FUNCTION_PINMUX_3	(PINCTRL_FUNCTION_PINMUX_BASE + 3)
#define PINCTRL_FUNCTION_PINMUX_4	(PINCTRL_FUNCTION_PINMUX_BASE + 4)
#define PINCTRL_FUNCTION_PINMUX_5	(PINCTRL_FUNCTION_PINMUX_BASE + 5)
#define PINCTRL_FUNCTION_PINMUX_6	(PINCTRL_FUNCTION_PINMUX_BASE + 6)
#define PINCTRL_FUNCTION_PINMUX_7	(PINCTRL_FUNCTION_PINMUX_BASE + 7)
#define PINCTRL_FUNCTION_PINMUX_8	(PINCTRL_FUNCTION_PINMUX_BASE + 8)
#define PINCTRL_FUNCTION_PINMUX_9	(PINCTRL_FUNCTION_PINMUX_BASE + 9)
#define PINCTRL_FUNCTION_PINMUX_10	(PINCTRL_FUNCTION_PINMUX_BASE + 10)
#define PINCTRL_FUNCTION_PINMUX_11	(PINCTRL_FUNCTION_PINMUX_BASE + 11)
#define PINCTRL_FUNCTION_PINMUX_12	(PINCTRL_FUNCTION_PINMUX_BASE + 12)
#define PINCTRL_FUNCTION_PINMUX_13	(PINCTRL_FUNCTION_PINMUX_BASE + 13)
#define PINCTRL_FUNCTION_PINMUX_14	(PINCTRL_FUNCTION_PINMUX_BASE + 14)
#define PINCTRL_FUNCTION_PINMUX_15	(PINCTRL_FUNCTION_PINMUX_BASE + 15)
#define PINCTRL_FUNCTION_PINMUX_16	(PINCTRL_FUNCTION_PINMUX_BASE + 16)
#define PINCTRL_FUNCTION_PINMUX_17	(PINCTRL_FUNCTION_PINMUX_BASE + 17)
#define PINCTRL_FUNCTION_PINMUX_18	(PINCTRL_FUNCTION_PINMUX_BASE + 18)
#define PINCTRL_FUNCTION_PINMUX_19	(PINCTRL_FUNCTION_PINMUX_BASE + 19)
#define PINCTRL_FUNCTION_PINMUX_20	(PINCTRL_FUNCTION_PINMUX_BASE + 20)
#define PINCTRL_FUNCTION_PINMUX_21	(PINCTRL_FUNCTION_PINMUX_BASE + 21)
#define PINCTRL_FUNCTION_PINMUX_22	(PINCTRL_FUNCTION_PINMUX_BASE + 22)
#define PINCTRL_FUNCTION_PINMUX_23	(PINCTRL_FUNCTION_PINMUX_BASE + 23)
#define PINCTRL_FUNCTION_PINMUX_24	(PINCTRL_FUNCTION_PINMUX_BASE + 24)
#define PINCTRL_FUNCTION_PINMUX_25	(PINCTRL_FUNCTION_PINMUX_BASE + 25)
#define PINCTRL_FUNCTION_PINMUX_26	(PINCTRL_FUNCTION_PINMUX_BASE + 26)
#define PINCTRL_FUNCTION_PINMUX_27	(PINCTRL_FUNCTION_PINMUX_BASE + 27)
#define PINCTRL_FUNCTION_PINMUX_28	(PINCTRL_FUNCTION_PINMUX_BASE + 28)
#define PINCTRL_FUNCTION_PINMUX_29	(PINCTRL_FUNCTION_PINMUX_BASE + 29)
#define PINCTRL_FUNCTION_PINMUX_30	(PINCTRL_FUNCTION_PINMUX_BASE + 30)
#define PINCTRL_FUNCTION_PINMUX_31	(PINCTRL_FUNCTION_PINMUX_BASE + 31)

/**@} pinctrl_interface_mux_defs */
