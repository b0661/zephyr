 ...
 *       the extended interface and SoCs switched to.
 *  ---------------------------------------------------
 */
#define GPIO_LEGACY_API 1
#if CONFIG_SOC_SERIES_STM32F0X
/* Not to be used with the legacy GPIO device drivers */
#undef GPIO_LEGACY_API
#define GPIO_LEGACY_API 0
